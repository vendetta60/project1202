 ...
 */
export const parseDateFromDDMMYYYY = (ddmmyyyyString: string | undefined | null): Date | null => {
...
/**
 * Format Date object to dd.mm.yyyy safely
 */
export const formatDateToDDMMYYYY_Safe = (date: Date | null | undefined): string => {
...
/**
 * Format text input with automatic dot insertion for dd.mm.yyyy
